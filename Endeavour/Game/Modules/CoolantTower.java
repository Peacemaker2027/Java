 ...
 * @author ebradford
 */
public class CoolantTower extends Module
{
    public CoolantTower(int mass, SimpleApplication app)
    {
        this.mass = mass;
        float scale = (float) Math.pow((this.mass/7850f), 1f/3f);
        this.spatial = app.getAssetManager().loadModel("Models/coolingtower.j3o");
        ...
        this.addPlugin(new Plugin("coolant liquid", this.mass, 0, false));
