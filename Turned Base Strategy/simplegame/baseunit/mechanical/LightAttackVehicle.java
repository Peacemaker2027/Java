...
public class LightAttackVehicle extends Mechanical implements Damage, Move, Cost
{
	private final int class_constant = -32;
	
	public LightAttackVehicle()
	{
		super(32+8, 32+8, "Light Attack Vehicle", "Light attack vehicle to fortify the front.", 0, 0, 2);
	}
	...
	public void setDamage(Biological unit)
	{
		if(this.isPlayable())
		{
			unit.setHealth(this.class_constant-8);
		}
	}
